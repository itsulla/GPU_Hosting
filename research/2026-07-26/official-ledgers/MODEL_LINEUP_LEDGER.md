...
| Google Gemma 4 26B-A4B | `Gemma 4 26B-A4B family release` | 25.2B total / 3.8B active; 262144 context | Apache-2.0 / Released | Publish as public-weights; size by total parameters | https://ai.google.dev/gemma/docs/core/model_card_4 |
